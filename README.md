...
- **Google Maps** and **Apple Maps** integration:
  - Map and visualize inspection locations
  - Launch turn-by-turn navigation from inspection details
...
- Additional metadata:
  ...
  - Contractor type (roofing, electrical, plumbing, etc.)
...
Each inspection supports multiple report views:
...
- Features:
  ...
  - Offline-friendly workflows for on-site inspections
...
- UUID-based URLs for:
  ...
  - Four-Point and Wind Mitigation PDFs
- Clients can:
  - Add or remove services (subject to rules)
  - Reschedule or cancel appointments
  - View signed agreements and payment status
...
- Any combination of:
  ...
  - Property managers
  - Other stakeholders
- All can be automatically copied on communication and report delivery
...
- **Twilio** – Voice calling, SMS, and AI campaigns
